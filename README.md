...
* **Unzip the Dataset:** Extract the "Data" folder.
* **Install the tools:** Run `pip install -r requirements.txt` to get all the required Python libraries.
* **Train the models:** Type `python [train.py]` in your terminal to start the comparison!
* **Run the models:** Type `python [app.py]` in your terminal to start the comparison!
